...
$(document).ready(function(){
	$(document).on('click','#saveBtn',function(){
		...
		if (content.length == 0) {
	 	...
	 	data.attr('action',"<c:url value='/fileBoard/commit'/>");
	 	data.submit();
	});
	...
	<div class="row">
		<form name="writeForm" method="post" enctype="multipart/form-data">
			<table class="table table-striped table-bordered">
				<tr>
					<td>제목 :</td>
					<td><input class="form-control" type="text" id="title" name="title" maxlength="200"></td>
				</tr>
				<tr>
					<td>글쓴이 :</td>
					<td>
				...
				<tr>
					<td colspan="2" id="contentBox">
						<textarea rows="20" cols="200" id="content" name="content" class="form-control" placeholder="본문을 입력하세요"></textarea>
					</td>
				</tr>
				<tr>
					<td>첨부 : </td>

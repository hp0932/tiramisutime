...
function selectPage(select){
	...
	if(searchedContent != ""){
		location.href="/fileBoard/list?nowPage=" + select + "&searchContent=" + searchedContent;
	}else{
		location.href="/fileBoard/list?nowPage=" + select;
	}
}

function searchPage(search){
	location.href="/fileBoard/list?searchContent=" + search;
}

function selectThread(select){
	location.href="/fileBoard/read?nowThread=" + select;
}
